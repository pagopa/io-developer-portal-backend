...
const createOrUpdateUser = (apiClient, userId, user) => apiClient.user.createOrUpdate(config.azurerm_resource_group, config.azurerm_apim, userId, user);
...
exports.createOrUpdateApimUser = (userData) => __awaiter(this, void 0, void 0, function* () {
    const loginCreds = yield login_1.login();
    const apiClient = new apiManagementClient(loginCreds.creds, loginCreds.subscriptionId);
    const user = yield createOrUpdateUser(apiClient, userData.uid, userData);
